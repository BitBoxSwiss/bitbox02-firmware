...
///Field `HTF` reader - half transfer flag An half transfer event is an half block transfer that occurs when half of the bytes of the source block size (rounded-up integer of LPDMA_CxBR1.BNDT\[15:0\] / 2) has been transferred to the destination.
