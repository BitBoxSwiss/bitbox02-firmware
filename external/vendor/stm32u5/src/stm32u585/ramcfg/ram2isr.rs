...
You can [`read`](crate::Reg::read) this register and get [`ram2isr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#RAMCFG:RAM2ISR)*/
pub struct RAM2ISRrs;
impl crate::RegisterSpec for RAM2ISRrs {
    type Ux = u32;
}
///`read()` method returns [`ram2isr::R`](R) reader structure
impl crate::Readable for RAM2ISRrs {}
///`reset()` method sets RAM2ISR to value 0
impl crate::Resettable for RAM2ISRrs {}
