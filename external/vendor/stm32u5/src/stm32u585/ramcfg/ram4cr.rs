...
pub type R = crate::R<RAM4CRrs>;
///Register `RAM4CR` writer
pub type W = crate::W<RAM4CRrs>;
...
impl W {
    ///Bit 0 - ECCE
    #[inline(always)]
    pub fn ecce(&mut self) -> ECCE_W<RAM4CRrs> {
        ECCE_W::new(self, 0)
    }
    ///Bit 4 - ALE
    #[inline(always)]
    pub fn ale(&mut self) -> ALE_W<RAM4CRrs> {
        ALE_W::new(self, 4)
    }
    ///Bit 8 - SRAMER
    #[inline(always)]
    pub fn sramer(&mut self) -> SRAMER_W<RAM4CRrs> {
        SRAMER_W::new(self, 8)
    }
    ///Bits 16:18 - WSC
    #[inline(always)]
    pub fn wsc(&mut self) -> WSC_W<RAM4CRrs> {
        WSC_W::new(self, 16)
    }
}
/**RAMCFG SRAM x control register

You can [`read`](crate::Reg::read) this register and get [`ram4cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram4cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U585.html#RAMCFG:RAM4CR)*/
pub struct RAM4CRrs;
impl crate::RegisterSpec for RAM4CRrs {
    type Ux = u32;
}
///`read()` method returns [`ram4cr::R`](R) reader structure
impl crate::Readable for RAM4CRrs {}
///`write(|w| ..)` method takes [`ram4cr::W`](W) writer structure
impl crate::Writable for RAM4CRrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RAM4CR to value 0
impl crate::Resettable for RAM4CRrs {}
