///Register `_DCR3` reader
pub type R = crate::R<_DCR3rs>;
///Register `_DCR3` writer
pub type W = crate::W<_DCR3rs>;
...
impl W {
    ///Bits 0:7 - Maximum transfer This field enables the communication regulation feature. The nCS is released every MAXTRAN+1 clock cycles when the other HSPI request the access to the bus. others: Maximum communication is set to MAXTRAN+1 bytes
    #[inline(always)]
    pub fn maxtran(&mut self) -> MAXTRAN_W<_DCR3rs> {
        MAXTRAN_W::new(self, 0)
    }
    ///Bits 16:20 - CS boundary This field enables the transaction boundary feature. When active, a minimum value of 3 is recommended. The nCS is released on each boundary of 2CSBOUND bytes. others: CS boundary set to 2CSBOUND bytes
    #[inline(always)]
    pub fn csbound(&mut self) -> CSBOUND_W<_DCR3rs> {
        CSBOUND_W::new(self, 16)
    }
}
/**HSPI device configuration register 3

You can [`read`](crate::Reg::read) this register and get [`_dcr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_dcr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

See register [structure](https://stm32-rs.github.io/stm32-rs/STM32U5A9.html#HSPI1:_DCR3)*/
pub struct _DCR3rs;
impl crate::RegisterSpec for _DCR3rs {
    type Ux = u32;
}
///`read()` method returns [`_dcr3::R`](R) reader structure
impl crate::Readable for _DCR3rs {}
///`write(|w| ..)` method takes [`_dcr3::W`](W) writer structure
impl crate::Writable for _DCR3rs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets _DCR3 to value 0
impl crate::Resettable for _DCR3rs {}
