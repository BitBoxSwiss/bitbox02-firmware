...
impl CH {
    ...
    ///0x0c - LPDMA channel x flag clear register
    #[inline(always)]
    ...
    ///0x40 - LPDMA channel x transfer register 1
    #[inline(always)]
    pub const fn tr1(&self) -> &TR1 {
        &self.tr1
    }
    ///0x44 - LPDMA channel x transfer register 2
    #[inline(always)]
    pub const fn tr2(&self) -> &TR2 {
        &self.tr2
    }
    ///0x48 - LPDMA channel x block register 1
    #[inline(always)]
    pub const fn br1(&self) -> &BR1 {
        &self.br1
    }
    ///0x4c - LPDMA channel x source address register
    #[inline(always)]
    pub const fn sar(&self) -> &SAR {
        &self.sar
    }
    ///0x50 - LPDMA channel x destination address register
    #[inline(always)]
    pub const fn dar(&self) -> &DAR {
        &self.dar
    }
    ///0x7c - LPDMA channel x linked-list address register
    #[inline(always)]
...
pub mod lbar;
/**FCR (w) register accessor: LPDMA channel x flag clear register
...
pub mod cr;
/**TR1 (rw) register accessor: LPDMA channel x transfer register 1
...
pub mod tr1;
/**TR2 (rw) register accessor: LPDMA channel x transfer register 2
...
pub mod tr2;
/**BR1 (rw) register accessor: LPDMA channel x block register 1
...
pub mod br1;
/**SAR (rw) register accessor: LPDMA channel x source address register
...
pub mod sar;
/**DAR (rw) register accessor: LPDMA channel x destination address register
...
pub mod dar;
/**LLR (rw) register accessor: LPDMA channel x linked-list address register
