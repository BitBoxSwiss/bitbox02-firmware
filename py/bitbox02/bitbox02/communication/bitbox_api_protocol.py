...
class BitBoxCommonAPI:
    ...
    def unlock(
        ...
        try:
            request = hww.Request()
            request.unlock.CopyFrom(keystore.UnlockRequest(
            ...
            while True:
                ...
                if response_type == "unlock_host_info" and response.unlock_host_info.type == keystore.UnlockRequestHostInfoResponse.InfoType.PASSPHRASE:
                    request = hww.Request()
                    request.unlock_host_info.CopyFrom(keystore.UnlockHostInfoRequest(
