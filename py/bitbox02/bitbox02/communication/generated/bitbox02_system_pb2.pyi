...
class InsertRemoveSDCardRequest(google.protobuf.message.Message):
    ...
    class _SDCardActionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SDCardAction.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        REMOVE_CARD = InsertRemoveSDCardRequest.SDCardAction.V(0)
        INSERT_CARD = InsertRemoveSDCardRequest.SDCardAction.V(1)

    REMOVE_CARD = InsertRemoveSDCardRequest.SDCardAction.V(0)
    INSERT_CARD = InsertRemoveSDCardRequest.SDCardAction.V(1)

    ACTION_FIELD_NUMBER: builtins.int
    action: global___InsertRemoveSDCardRequest.SDCardAction.V = ...
    def __init__(self,
        *,
        action : global___InsertRemoveSDCardRequest.SDCardAction.V = ...,
        ) -> None: ...
