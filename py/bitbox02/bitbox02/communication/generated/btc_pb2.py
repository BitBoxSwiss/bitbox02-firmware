...
_BTCSCRIPTCONFIG_MULTISIG_SCRIPTTYPE = _descriptor.EnumDescriptor(
  name='ScriptType',
  full_name='shiftcrypto.bitbox02.BTCScriptConfig.Multisig.ScriptType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='P2WSH', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='P2WSH_P2SH', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_BTCSCRIPTCONFIG_MULTISIG_SCRIPTTYPE)
...
_BTCPUBREQUEST_XPUBTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CAPITAL_UPUB', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CAPITAL_YPUB', index=9, number=9,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_BTCSIGNNEXTRESPONSE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HOST_NONCE', index=6, number=6,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_BTCREGISTERSCRIPTCONFIGREQUEST_XPUBTYPE = _descriptor.EnumDescriptor(
  name='XPubType',
  full_name='shiftcrypto.bitbox02.BTCRegisterScriptConfigRequest.XPubType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='AUTO_ELECTRUM', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUTO_XPUB_TPUB', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_BTCSCRIPTCONFIG_MULTISIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='script_type', full_name='shiftcrypto.bitbox02.BTCScriptConfig.Multisig.script_type', index=3,
  ...
  nested_types=[],
  enum_types=[
    _BTCSCRIPTCONFIG_MULTISIG_SCRIPTTYPE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto3',
...
_BTCSIGNNEXTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anti_klepto_signer_commitment', full_name='shiftcrypto.bitbox02.BTCSignNextResponse.anti_klepto_signer_commitment', index=5,
...
_BTCSIGNINPUTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='host_nonce_commitment', full_name='shiftcrypto.bitbox02.BTCSignInputRequest.host_nonce_commitment', index=6,
...
_BTCREGISTERSCRIPTCONFIGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='xpub_type', full_name='shiftcrypto.bitbox02.BTCRegisterScriptConfigRequest.xpub_type', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BTCSIGNMESSAGEREQUEST = _descriptor.Descriptor(
  name='BTCSignMessageRequest',
  full_name='shiftcrypto.bitbox02.BTCSignMessageRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='coin', full_name='shiftcrypto.bitbox02.BTCSignMessageRequest.coin', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='script_config', full_name='shiftcrypto.bitbox02.BTCSignMessageRequest.script_config', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='msg', full_name='shiftcrypto.bitbox02.BTCSignMessageRequest.msg', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='host_nonce_commitment', full_name='shiftcrypto.bitbox02.BTCSignMessageRequest.host_nonce_commitment', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BTCSIGNMESSAGERESPONSE = _descriptor.Descriptor(
  name='BTCSignMessageResponse',
  full_name='shiftcrypto.bitbox02.BTCSignMessageResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='signature', full_name='shiftcrypto.bitbox02.BTCSignMessageResponse.signature', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BTCREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sign_message', full_name='shiftcrypto.bitbox02.BTCRequest.sign_message', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='antiklepto_signature', full_name='shiftcrypto.bitbox02.BTCRequest.antiklepto_signature', index=6,
...
_BTCRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sign_message', full_name='shiftcrypto.bitbox02.BTCResponse.sign_message', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='antiklepto_signer_commitment', full_name='shiftcrypto.bitbox02.BTCResponse.antiklepto_signer_commitment', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BTCSCRIPTCONFIG_MULTISIG.fields_by_name['script_type'].enum_type = _BTCSCRIPTCONFIG_MULTISIG_SCRIPTTYPE
_BTCSCRIPTCONFIG_MULTISIG.containing_type = _BTCSCRIPTCONFIG
_BTCSCRIPTCONFIG_MULTISIG_SCRIPTTYPE.containing_type = _BTCSCRIPTCONFIG_MULTISIG
...
_BTCSIGNNEXTRESPONSE.fields_by_name['anti_klepto_signer_commitment'].message_type = antiklepto__pb2._ANTIKLEPTOSIGNERCOMMITMENT
_BTCSIGNNEXTRESPONSE_TYPE.containing_type = _BTCSIGNNEXTRESPONSE
_BTCSIGNINPUTREQUEST.fields_by_name['host_nonce_commitment'].message_type = antiklepto__pb2._ANTIKLEPTOHOSTNONCECOMMITMENT
...
_BTCREGISTERSCRIPTCONFIGREQUEST.fields_by_name['xpub_type'].enum_type = _BTCREGISTERSCRIPTCONFIGREQUEST_XPUBTYPE
_BTCREGISTERSCRIPTCONFIGREQUEST_XPUBTYPE.containing_type = _BTCREGISTERSCRIPTCONFIGREQUEST
_BTCSIGNMESSAGEREQUEST.fields_by_name['coin'].enum_type = _BTCCOIN
_BTCSIGNMESSAGEREQUEST.fields_by_name['script_config'].message_type = _BTCSCRIPTCONFIGWITHKEYPATH
_BTCSIGNMESSAGEREQUEST.fields_by_name['host_nonce_commitment'].message_type = antiklepto__pb2._ANTIKLEPTOHOSTNONCECOMMITMENT
...
_BTCREQUEST.fields_by_name['sign_message'].message_type = _BTCSIGNMESSAGEREQUEST
_BTCREQUEST.fields_by_name['antiklepto_signature'].message_type = antiklepto__pb2._ANTIKLEPTOSIGNATUREREQUEST
...
_BTCREQUEST.oneofs_by_name['request'].fields.append(
  _BTCREQUEST.fields_by_name['sign_message'])
_BTCREQUEST.fields_by_name['sign_message'].containing_oneof = _BTCREQUEST.oneofs_by_name['request']
_BTCREQUEST.oneofs_by_name['request'].fields.append(
  _BTCREQUEST.fields_by_name['antiklepto_signature'])
_BTCREQUEST.fields_by_name['antiklepto_signature'].containing_oneof = _BTCREQUEST.oneofs_by_name['request']
...
_BTCRESPONSE.fields_by_name['sign_message'].message_type = _BTCSIGNMESSAGERESPONSE
_BTCRESPONSE.fields_by_name['antiklepto_signer_commitment'].message_type = antiklepto__pb2._ANTIKLEPTOSIGNERCOMMITMENT
...
_BTCRESPONSE.oneofs_by_name['response'].fields.append(
  _BTCRESPONSE.fields_by_name['sign_message'])
_BTCRESPONSE.fields_by_name['sign_message'].containing_oneof = _BTCRESPONSE.oneofs_by_name['response']
_BTCRESPONSE.oneofs_by_name['response'].fields.append(
  _BTCRESPONSE.fields_by_name['antiklepto_signer_commitment'])
_BTCRESPONSE.fields_by_name['antiklepto_signer_commitment'].containing_oneof = _BTCRESPONSE.oneofs_by_name['response']
...
DESCRIPTOR.message_types_by_name['BTCSignMessageRequest'] = _BTCSIGNMESSAGEREQUEST
DESCRIPTOR.message_types_by_name['BTCSignMessageResponse'] = _BTCSIGNMESSAGERESPONSE
...
BTCSignMessageRequest = _reflection.GeneratedProtocolMessageType('BTCSignMessageRequest', (_message.Message,), dict(
  DESCRIPTOR = _BTCSIGNMESSAGEREQUEST,
  __module__ = 'btc_pb2'
  # @@protoc_insertion_point(class_scope:shiftcrypto.bitbox02.BTCSignMessageRequest)
  ))
_sym_db.RegisterMessage(BTCSignMessageRequest)

BTCSignMessageResponse = _reflection.GeneratedProtocolMessageType('BTCSignMessageResponse', (_message.Message,), dict(
  DESCRIPTOR = _BTCSIGNMESSAGERESPONSE,
  __module__ = 'btc_pb2'
  # @@protoc_insertion_point(class_scope:shiftcrypto.bitbox02.BTCSignMessageResponse)
  ))
_sym_db.RegisterMessage(BTCSignMessageResponse)
