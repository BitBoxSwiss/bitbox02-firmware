...
class BTCRequest(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",u"register_script_config",u"request"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",u"register_script_config",u"request"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",b"is_script_config_registered",u"register_script_config",b"register_script_config",u"request",b"request"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",b"is_script_config_registered",u"register_script_config",b"register_script_config",u"request",b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"request",b"request"]) -> typing_extensions___Literal["is_script_config_registered","register_script_config"]: ...
...
class BTCResponse(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",u"response",u"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",u"response",u"success"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",b"is_script_config_registered",u"response",b"response",u"success",b"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"is_script_config_registered",b"is_script_config_registered",u"response",b"response",u"success",b"success"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"response",b"response"]) -> typing_extensions___Literal["success","is_script_config_registered"]: ...
