...
class CardanoRequest(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"address",u"request",u"xpubs"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"address",u"request",u"xpubs"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"address",b"address",u"request",b"request",u"xpubs",b"xpubs"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"address",b"address",u"request",b"request",u"xpubs",b"xpubs"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"request",b"request"]) -> typing_extensions___Literal["xpubs","address"]: ...
...
class CardanoResponse(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"pub",u"response",u"xpubs"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"pub",u"response",u"xpubs"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"pub",b"pub",u"response",b"response",u"xpubs",b"xpubs"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"pub",b"pub",u"response",b"response",u"xpubs",b"xpubs"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"response",b"response"]) -> typing_extensions___Literal["xpubs","pub"]: ...
