...
class CardanoSignTransactionRequest(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"certificates",u"fee",u"inputs",u"network",u"outputs",u"ttl",u"withdrawals"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"certificates",b"certificates",u"fee",b"fee",u"inputs",b"inputs",u"network",b"network",u"outputs",b"outputs",u"ttl",b"ttl",u"withdrawals",b"withdrawals"]) -> None: ...
