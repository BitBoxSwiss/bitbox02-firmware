...
class _CardanoNetworkEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CardanoNetwork.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    CardanoMainnet = CardanoNetwork.V(0)
    CardanoTestnet = CardanoNetwork.V(1)
...
class CardanoSignTransactionRequest(google.protobuf.message.Message):
    ...
    class Output(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["script_config",b"script_config"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["encoded_address",b"encoded_address","script_config",b"script_config","value",b"value"]) -> None: ...
