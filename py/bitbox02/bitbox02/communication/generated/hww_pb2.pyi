...
from .btc_pb2 import (
    ...
    BTCRequest as btc_pb2___BTCRequest,
    BTCResponse as btc_pb2___BTCResponse,
...
from .cardano_pb2 import (
    CardanoRequest as cardano_pb2___CardanoRequest,
    CardanoResponse as cardano_pb2___CardanoResponse,
)
...
from .keystore_pb2 import (
    ElectrumEncryptionKeyRequest as keystore_pb2___ElectrumEncryptionKeyRequest,
    ElectrumEncryptionKeyResponse as keystore_pb2___ElectrumEncryptionKeyResponse,
)
...
class Request(google___protobuf___message___Message):
    ...
    @property
    def btc(self) -> btc_pb2___BTCRequest: ...

    @property
    def electrum_encryption_key(self) -> keystore_pb2___ElectrumEncryptionKeyRequest: ...

    @property
    def cardano(self) -> cardano_pb2___CardanoRequest: ...
    ...
    def __init__(self,
        *,
        ...
        btc : typing___Optional[btc_pb2___BTCRequest] = None,
        electrum_encryption_key : typing___Optional[keystore_pb2___ElectrumEncryptionKeyRequest] = None,
        cardano : typing___Optional[cardano_pb2___CardanoRequest] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"btc",u"btc_pub",u"btc_sign_init",u"btc_sign_input",u"btc_sign_output",u"cardano",u"check_backup",u"check_sdcard",u"create_backup",u"device_info",u"device_language",u"device_name",u"electrum_encryption_key",u"eth",u"fingerprint",u"insert_remove_sdcard",u"list_backups",u"perform_attestation",u"reboot",u"request",u"reset",u"restore_backup",u"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",u"set_password",u"show_mnemonic"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc",u"btc_pub",u"btc_sign_init",u"btc_sign_input",u"btc_sign_output",u"cardano",u"check_backup",u"check_sdcard",u"create_backup",u"device_info",u"device_language",u"device_name",u"electrum_encryption_key",u"eth",u"fingerprint",u"insert_remove_sdcard",u"list_backups",u"perform_attestation",u"reboot",u"request",u"reset",u"restore_backup",u"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",u"set_password",u"show_mnemonic"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"btc",b"btc",u"btc_pub",b"btc_pub",u"btc_sign_init",b"btc_sign_init",u"btc_sign_input",b"btc_sign_input",u"btc_sign_output",b"btc_sign_output",u"cardano",b"cardano",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"create_backup",b"create_backup",u"device_info",b"device_info",u"device_language",b"device_language",u"device_name",b"device_name",u"electrum_encryption_key",b"electrum_encryption_key",u"eth",b"eth",u"fingerprint",b"fingerprint",u"insert_remove_sdcard",b"insert_remove_sdcard",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"reboot",b"reboot",u"request",b"request",u"reset",b"reset",u"restore_backup",b"restore_backup",u"restore_from_mnemonic",b"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",b"set_mnemonic_passphrase_enabled",u"set_password",b"set_password",u"show_mnemonic",b"show_mnemonic"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc",b"btc",u"btc_pub",b"btc_pub",u"btc_sign_init",b"btc_sign_init",u"btc_sign_input",b"btc_sign_input",u"btc_sign_output",b"btc_sign_output",u"cardano",b"cardano",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"create_backup",b"create_backup",u"device_info",b"device_info",u"device_language",b"device_language",u"device_name",b"device_name",u"electrum_encryption_key",b"electrum_encryption_key",u"eth",b"eth",u"fingerprint",b"fingerprint",u"insert_remove_sdcard",b"insert_remove_sdcard",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"reboot",b"reboot",u"request",b"request",u"reset",b"reset",u"restore_backup",b"restore_backup",u"restore_from_mnemonic",b"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",b"set_mnemonic_passphrase_enabled",u"set_password",b"set_password",u"show_mnemonic",b"show_mnemonic"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"request",b"request"]) -> typing_extensions___Literal["device_name","device_language","device_info","set_password","create_backup","show_mnemonic","btc_pub","btc_sign_init","btc_sign_input","btc_sign_output","insert_remove_sdcard","check_sdcard","set_mnemonic_passphrase_enabled","list_backups","restore_backup","perform_attestation","reboot","check_backup","eth","reset","restore_from_mnemonic","fingerprint","btc","electrum_encryption_key","cardano"]: ...
...
class Response(google___protobuf___message___Message):
    ...
    @property
    def btc(self) -> btc_pb2___BTCResponse: ...

    @property
    def electrum_encryption_key(self) -> keystore_pb2___ElectrumEncryptionKeyResponse: ...

    @property
    def cardano(self) -> cardano_pb2___CardanoResponse: ...
    ...
    def __init__(self,
        *,
        ...
        btc : typing___Optional[btc_pb2___BTCResponse] = None,
        electrum_encryption_key : typing___Optional[keystore_pb2___ElectrumEncryptionKeyResponse] = None,
        cardano : typing___Optional[cardano_pb2___CardanoResponse] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"btc",u"btc_sign_next",u"cardano",u"check_backup",u"check_sdcard",u"device_info",u"electrum_encryption_key",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"response",u"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc",u"btc_sign_next",u"cardano",u"check_backup",u"check_sdcard",u"device_info",u"electrum_encryption_key",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"response",u"success"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"btc",b"btc",u"btc_sign_next",b"btc_sign_next",u"cardano",b"cardano",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"device_info",b"device_info",u"electrum_encryption_key",b"electrum_encryption_key",u"error",b"error",u"eth",b"eth",u"fingerprint",b"fingerprint",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"pub",b"pub",u"response",b"response",u"success",b"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc",b"btc",u"btc_sign_next",b"btc_sign_next",u"cardano",b"cardano",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"device_info",b"device_info",u"electrum_encryption_key",b"electrum_encryption_key",u"error",b"error",u"eth",b"eth",u"fingerprint",b"fingerprint",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"pub",b"pub",u"response",b"response",u"success",b"success"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"response",b"response"]) -> typing_extensions___Literal["success","error","device_info","pub","btc_sign_next","list_backups","check_backup","perform_attestation","check_sdcard","eth","fingerprint","btc","electrum_encryption_key","cardano"]: ...
