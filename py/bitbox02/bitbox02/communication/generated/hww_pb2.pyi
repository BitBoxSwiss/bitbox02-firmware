...
class Response(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"btc",u"btc_sign_next",u"check_backup",u"check_sdcard",u"device_info",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"random_number",u"response",u"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc",u"btc_sign_next",u"check_backup",u"check_sdcard",u"device_info",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"random_number",u"response",u"success"]) -> None: ...
    else:
    ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"response",b"response"]) -> typing_extensions___Literal["success","error","random_number","device_info","pub","btc_sign_next","list_backups","check_backup","perform_attestation","check_sdcard","eth","fingerprint","btc"]: ...
