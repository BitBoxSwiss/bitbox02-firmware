...
class Request(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        unlock: typing.Optional[keystore_pb2.UnlockRequest] = ...,
        unlock_host_info: typing.Optional[keystore_pb2.UnlockHostInfoRequest] = ...,
        ) -> None: ...
...
class Response(google.protobuf.message.Message):
    ...
    @property
    def unlock_host_info(self) -> keystore_pb2.UnlockRequestHostInfoResponse: ...
    def __init__(self,
        *,
        ...
        unlock_host_info: typing.Optional[keystore_pb2.UnlockRequestHostInfoResponse] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["response",b"response"]) -> typing.Optional[typing_extensions.Literal["success","error","device_info","pub","btc_sign_next","list_backups","check_backup","perform_attestation","check_sdcard","eth","fingerprint","btc","electrum_encryption_key","cardano","bip85","unlock_host_info"]]: ...
