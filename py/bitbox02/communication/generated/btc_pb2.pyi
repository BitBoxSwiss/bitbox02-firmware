...
class BTCScriptConfig(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"config",u"simple_type"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"config",u"simple_type"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"config",b"config",u"simple_type",b"simple_type"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"config",b"config",u"simple_type",b"simple_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"config",b"config"]) -> typing_extensions___Literal["simple_type"]: ...
