...
def write_cmake_vars(path, firmware_info, bootloader_info):
...
def generate_headers(repo_root, output_dir, cmake_vars_out=None, manifest_path=None):
    ...
    firmware_info = build_version_info(
        manifest["firmware"],
        strict_tag_version(repo_root, "firmware"),
        git_commit_hash_short,
    )
    bootloader_info = build_version_info(
        manifest["bootloader"],
        strict_tag_version(repo_root, "bootloader"),
        git_commit_hash_short,
    )
    ...
    if cmake_vars_out is not None:
        write_cmake_vars(cmake_vars_out, firmware_info, bootloader_info)
