...
__attribute__((always_inline)) __STATIC_INLINE uint32_t __REV16(uint32_t value)
{
    ...
    __ASM volatile ("rev16 %0, %1" : __CMSIS_GCC_OUT_REG (result) : __CMSIS_GCC_USE_REG (
                        value) );
    return (result);
}
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __REVSH(int32_t value)
{
    ...
    __ASM volatile ("revsh %0, %1" : __CMSIS_GCC_OUT_REG (result) : __CMSIS_GCC_USE_REG (
                        value) );
    return (result);
#endif
}
...
__attribute__((always_inline)) __STATIC_INLINE int32_t __SMMLA (int32_t op1, int32_t op2,
        int32_t op3)
{
    int32_t result;
