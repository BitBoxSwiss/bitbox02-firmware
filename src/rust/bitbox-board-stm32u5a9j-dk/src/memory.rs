...
const _: () = {
    ...
    assert!(IMMUTABLE_PAGE_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(BOOT0_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(BOOT0_MAX_LEN.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(BOOT1_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(BOOT1_MAX_LEN.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(FIRMWARE_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(FIRMWARE_MAX_LEN.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(VENDOR_DATA_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(VENDOR_DATA_LEN.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(USER_DATA_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(USER_DATA_LEN.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(DFU_BOOT1_ADDR.is_multiple_of(FLASH_PAGE_SIZE));
    assert!(DFU_BOOT1_MAX_LEN.is_multiple_of(FLASH_PAGE_SIZE));
};
