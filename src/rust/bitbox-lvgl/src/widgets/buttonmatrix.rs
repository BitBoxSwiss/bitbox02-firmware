...
use crate::{LvButtonmatrixCtrl, LvHandle, LvObj, ObjExt, ZeroizingText, class, ffi};
...
pub trait ButtonmatrixExt: ObjExt {
    ...
    fn get_map(&self) -> Vec<ZeroizingText> {
        unsafe {
    ...
    fn get_button_text(&self, button_id: u32) -> Option<ZeroizingText> {
        unsafe {
