...
pub unsafe extern "C" fn rust_derive_bip39_seed(
    ...
    mut bip39_seed_out: crate::util::BytesMut,
    mut root_fingerprint_out: crate::util::BytesMut,
) {
    let mnemonic =
    ...
    let root_fingerprint: [u8; 4] =
        bitcoin::bip32::Xpriv::new_master(bitcoin::NetworkKind::Main, bip39_seed.as_ref())
            .unwrap()
            .fingerprint(bitbox02_rust::secp256k1::SECP256K1)
            .to_bytes();
        ...
        for test in tests {
            ...
            unsafe {
                rust_derive_bip39_seed(
                    ...
                    crate::util::rust_util_bytes_mut(
