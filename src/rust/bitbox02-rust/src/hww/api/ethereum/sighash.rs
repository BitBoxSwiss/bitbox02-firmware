...
mod tests {
    ...
    // Simple JSON parser for test data. Extracts string values for known keys.
    ...
    // Test vectors generated by Go scripts in testdata/
    // See: gen_eip1559_tests.go, gen_legacy_tests.go
    ...
    fn test_compute_eip1559() {
        ...
        for (i, obj) in objects.iter().enumerate() {
            ...
            let expected_sighash: [u8; 32] = decode_hex(extract_json_string(obj, "expected_sighash"))
                .try_into()
                .unwrap();
