...
mod tests {
    ...
    async fn run_single_message_typed_msg(
        ...
        run_single_named_message_typed_msg("data", member_type, message_obj).await
    }

    async fn run_single_named_message_typed_msg(
        member_name: &str,
        member_type: MemberType,
        message_obj: Object<'static>,
    ) -> TestingHal<'static> {
    ...
    async fn test_hash_array_truncation_warning() {
        ...
        let mock_hal = run_single_named_message_typed_msg(
            &member_name,
