...
pub async fn from_file(
    ...
    {
        let datetime_string =
            bitbox_datetime::format_datetime(request.timestamp, request.timezone_offset, false)
...
pub async fn from_mnemonic(
    ...
    #[cfg(feature = "app-u2f")]
    {
        let datetime_string = bitbox_datetime::format_datetime(timestamp, timezone_offset, false)
            .map_err(|_| Error::InvalidInput)?;
        hal.ui()
            .confirm(&confirm::Params {
                title: "Is now?",
