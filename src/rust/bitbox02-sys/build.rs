...
pub fn main() -> Result<(), &'static str> {
    ...
    let res = Command::new("bindgen")
        ...
        .args(["--allowlist-function", "atecc_attestation_sign"])
        .args(["--allowlist-function", "atecc_monotonic_increments_remaining"])
        .args(["--allowlist-function", "atecc_u2f_counter_set"])
        .args(["--allowlist-function", "atecc_model"])
        .args(["--rustified-enum", "atecc_model_t"])
