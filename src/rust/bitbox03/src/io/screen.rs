use bitbox_lvgl::{
    ...
    lv_obj_set_size, lv_obj_set_style_bg_color, lv_screen_active, lv_spinner_create,
...
pub fn splash() {
    ...
    lv_obj_align(&spinner, LvAlign::LV_ALIGN_TOP_LEFT, 0, 0);

    let spinner = lv_spinner_create(&scr).expect("create spinner");
    lv_spinner_set_anim_params(&spinner, 1500 /* duration */, 240 /*angle*/);
    lv_obj_set_size(&spinner, 128, 128);
    lv_obj_align(&spinner, LvAlign::LV_ALIGN_TOP_RIGHT,  0, 0);

    let spinner = lv_spinner_create(&scr).expect("create spinner");
    lv_spinner_set_anim_params(&spinner, 750 /* duration */, 240 /*angle*/);
    lv_obj_set_size(&spinner, 128, 128);
    lv_obj_align(&spinner, LvAlign::LV_ALIGN_BOTTOM_LEFT, 0, 0);

    let spinner = lv_spinner_create(&scr).expect("create spinner");
    lv_spinner_set_anim_params(&spinner, 375 /* duration */, 240 /*angle*/);
    lv_obj_set_size(&spinner, 128, 128);
    lv_obj_align(&spinner, LvAlign::LV_ALIGN_BOTTOM_RIGHT, 0, 0);
}
